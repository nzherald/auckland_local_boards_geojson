auckland_local_boards_geojson
============================

Auckland Local Board boundaries as used by Statistics New Zealand, converted to GeoJSON
...
```
"auckland_local_boards_geojson": "git://github.com/nzherald/auckland_local_boards_geojson#1.0.0"
```
...
```
asset 'auckland_local_boards_geojson', '1.0.0', github: 'nzherald/auckland_local_boards_geojson'
```
